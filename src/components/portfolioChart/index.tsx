...
const PortfolioChart = ({ portfolioHistory }: PortfolioChartProps) => {
  ...
  return (
    <div className="border-stroke shadow-default dark:border-dark-3 dark:bg-dark-2 shadow-1 dark:shadow-card rounded-sm border bg-white p-6">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-xl font-semibold text-black">Portfolio Value</h3>
        <select
          value={timeRange}
          onChange={(e) => {
          ...
          className="border-stroke dark:border-dark-3 rounded-lg border bg-transparent px-3 py-2 text-sm font-medium text-black outline-none transition-all focus:border-primary"
        >
        ...
        <div className="min-w-[600px]">
          ...
          <div className="relative h-[400px]">
            ...
            {selectedPointIndex !== null && (
              <div
                className="dark:bg-dark-2 border-stroke dark:border-dark-3 animate-fadeIn absolute z-10 rounded-lg border bg-white p-4 shadow-lg"
                style={{
              ...
              >
                ...
                <div className="text-base font-semibold text-black dark:text-white">
                  $
                  {chartData.data[selectedPointIndex].toLocaleString(
                    undefined,
                    {

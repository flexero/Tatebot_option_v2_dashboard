...
const OpenOptionsPositions = ({ openPositions }: { openPositions: any[] }) => {
  ...
  const handleConfirmClose = () => {
    ...
    const result = apiClient
      .post("/api/trader/sellOptionsOrder", payload)
      .then((res) => {
        if (res.data === 200) {
    ...
    >
      ...
      <div className="flex flex-col items-center justify-between gap-6 rounded-2xl bg-white p-6 shadow-sm dark:bg-gray-800 md:flex-row">
        ...
        <div className="flex flex-col items-center gap-2 md:items-start">
          <h2 className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-2xl font-bold text-transparent">
            Options Open Positions
          </h2>
          <div className="flex items-center gap-4 text-sm">
            <span className="text-gray-500 dark:text-gray-400">
              Total Positions: {openPositions.length}
            </span>
          ...
          <div className="relative">
            <select
              ...
              className="w-full appearance-none rounded-xl border border-gray-200 bg-gray-50 px-4 
                         py-2.5 pr-10 text-sm font-medium text-gray-700 transition-all duration-200 focus:border-violet-500
                         focus:outline-none focus:ring-2 focus:ring-violet-500/20 dark:border-gray-700
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Are you sure you want to close your options position for{" "}
